...
<body class="bgColor">
                ...
                <div class="container-fluid d-flex justify-content-center">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active botonCategoria" aria-current="page" href="../index.php">Volver</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu bg-secondary">
                                    <li>
                                        <a class="dropdown-item text-white itemCategorias botonCategoria" 
                                        ="./categorias/celulares.php">Celulares</a>
                                    </li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item text-white itemCategorias botonCategoria" 
                                    href="./monitores.php">Monitores</a>
                                    </li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
    ...
    <main class="container mt-5">
        ...
        <div  class="container text-center row d-flex justify-content-center mx-auto">
            <?php
            $sentencia=$pdo->prepare("SELECT * FROM `productos` WHERE id_categoria = 1;");
